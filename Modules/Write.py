...
import os
def write_xyz_file(atomic_symbols, coordinates, filename, comment=None, overwrite=False, append=False, success_comment="Successfully wrote XYZ file to"):
    """
...
def write_mol_file(normalmodeEnergies,normalmodes,normfactors,coordinates,atoms,parentfolder="./"):
    '''
