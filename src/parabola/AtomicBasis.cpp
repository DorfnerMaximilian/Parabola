...
static std::vector<std::complex<double>> get_Phase_Operators(
    ...
    for (int i = 0; i < atoms_set1.size(); ++i) {
        ...
        std::vector<double> alphas_list(alphas_set1.begin() + alphasIndex_set1,
                                        alphas_set1.begin() + alphasIndex_set1 + alphasLength);
        alphasIndex_set1 += alphasLength;

        int contrCoefLength = contr_coefLengths_set1[i];
        std::vector<double> contr_coef_list(contr_coef_set1.begin() + contrCoefIndex_set1,
    ...
    for (int i = 0; i < atoms_set2.size(); ++i) {
        ...
        std::vector<double> alphas_list(alphas_set2.begin() + alphasIndex_set2,
                                        alphas_set2.begin() + alphasIndex_set2 + alphasLength);
        alphasIndex_set2 += alphasLength;

        int contrCoefLength = contr_coefLengths_set2[i];
        std::vector<double> contr_coef_list(contr_coef_set2.begin() + contrCoefIndex_set2,
